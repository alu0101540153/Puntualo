    ...
    <div v-if="!hideHeader" class="flex items-center justify-between mb-6">
      ...
      <div>
        <button 
          ...
          class="bg-gradient-to-r from-primary-500 to-accent-500 hover:brightness-110 text-white font-semibold px-5 py-2.5 rounded-full shadow-glow transition-all duration-300 hover:scale-105 hover:shadow-glow-lg"
        >
          Ver más
        </button>
        <router-link 
          v-else 
          to="/search" 
          class="bg-gradient-to-r from-primary-500 to-accent-500 hover:brightness-110 text-white font-semibold px-5 py-2.5 rounded-full shadow-glow transition-all duration-300 hover:scale-105 hover:shadow-glow-lg inline-block"
        >
          + Añadir
        </router-link>
      </div>
