<template>
  <div class="min-h-screen bg-gradient-to-b from-gray-700 to-gray-900">
    ...
    <main class="max-w-6xl mx-auto px-4 py-8 mt-6">
      <h2 class="text-2xl font-bold text-white mb-6">Vistos de {{ user?.name || 'usuario' }}</h2>

      <div v-if="loading" class="text-gray-300">Cargando vistos...</div>
      <div v-else-if="items.length === 0" class="text-gray-300">No tiene vistos públicos.</div>
