<template>
  <div class="min-h-screen bg-gradient-dark">
    ...
    <main class="max-w-6xl mx-auto px-4 py-8">
      ...
      <section class="mb-12">
        <div class="bg-gradient-to-br from-dark-800/60 to-black/80 backdrop-blur-md rounded-3xl p-8 border border-primary-500/20 shadow-cinema hover:border-primary-500/40 hover:shadow-glow transition-all duration-300">
